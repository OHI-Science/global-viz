...
\institute{Report Generated on Sep 06 2018}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Removed 1 rows containing missing values (position\_stack).}}\end{kframe}
\includegraphics[width=\maxwidth]{figure/rgn_rankplot-1} 
